...
class WalkingState:
    ...
    def do(boy):
        ...
        boy.x = clamp(30, boy.x, boy.bg.w - 30)
        boy.y = clamp(30, boy.y, boy.bg.h - 30)
...
class Boy:
    ...
    def draw(self):
        ...
        self.font.draw(self.x - self.bg.window_left - 80, self.y - self.bg.window_bottom + 50,
                       '(%3.2f, %3.2f)' % (self.x, self.y), (255, 255, 0))
        self.font.draw(self.x - self.bg.window_left - 60, self.y - self.bg.window_bottom + 70,
                       '(Ball : %5d)' % (self.my_ball), (255, 255, 0))
